...
left[0]   = "小さい";
right[0]  = "大きい";
def[0]    = "<p>今回の練習環境におけるピアノの指練習はどの程度の知的・知覚的活動（考える，記憶する，見るなど）を必要としましたか. <br>指練習の課題はやさしかったですか難しかったですか，単純でしたか複雑でしたか，正確さが求められましたか大ざっぱでよかったですか．</p>";

scale[1]  = "身体的要求"; 
left[1]   = "小さい";
right[1]  = "大きい";
def[1]    = "<p>今回の練習環境におけるピアノの指練習は, どの程度の身体的活動（押す，引く，回す，制御する，動き回るなど）を必要としましたか．<br>作業はラクでしたかキツかったですか，ゆっくりできましたかキビキビやらなければなりませんでしたか，休み休みできましたか働きづめでしたか．</p>";

scale[2]  = "タイムプレッシャー"; 
left[2]   = "弱い";
right[2]  = "強い";
def[2]    = "<p>今回の練習環境におけるピアノの指練習が行う際に感じる時間的切迫感はどの程度でしたか．<br>ペースはゆっくりとして余裕があるものでしたか，それとも速くて余裕のないものでしたか．</p>";

scale[3]  = "パフォーマンス（作業達成度）"; 
left[3]   = "良い";
right[3]  = "悪い";
def[3]    = "<p>今回の練習環境におけるピアノの指練習において，作業指示者によって設定された課題の目標をどの程度達成できたと思いますか．<br>目標の達成に関して自分のパフォーマンスにどの程度満足していますか．</p>";

scale[4]  = "努力"; 
left[4]   = "少ない";
right[4]  = "多い";
def[4]    = "<p>今回の練習環境におけるピアノの指練習において，パフォーマンスのレベルを達成・維持するために，精神的・身体的にどの程度いっしょうけんめいに作業しなければなりませんでしたか．</p>";

scale[5]  = "フラストレーション"; 
left[5]   = "低い";
right[5]  = "高い";
def[5]    = "<p>今回の練習環境におけるピアノの指練習中に，不安感，落胆，いらいら，ストレス，悩みをどの程度感じましたか．<br>あるいは逆に，安心感，満足感，充足感，楽しさ，リラックスをどの程度感じましたか．</p>";
